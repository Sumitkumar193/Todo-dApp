...
module.exports = {
  ...
  networks: {
    ...
    //
    development: {
     host: BLOCKCHAIN_HOST || 'localhost',        // Localhost (default: none)
     port: BLOCKCHAIN_PORT || 7545,               // Standard Ethereum port (default: none)
     network_id: BLOCKCHAIN_NETWORK || '*',       // Any network (default: none)
    },
    //
